...
public class RegisterCenterService {
     ...
     */
    private static final Map<String, ConcurrentMap<String, RegisterService>> PROVIDER_PATH_MAP = new ConcurrentHashMap<>();
     ...
     */
    private static final Map<String, Map<String, RegisterService>> CONSUMER_PATH_MAP = new ConcurrentHashMap<>();
    ...
    public void start() throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                KEEP_ALIVE_EXECUTOR.scheduleWithFixedDelay(new KeepAliveTask(), Const.SCAN_TIME, Const.SCAN_TIME, TimeUnit.SECONDS);
                // 服务发现线程池
